...
parser.add_argument('--loadmodel', default='./trained/pretrained_sceneflow.tar',
                    help='loading model')
parser.add_argument('--leftimg', default= './test_img/00.png',
                    help='load model')
parser.add_argument('--rightimg', default= './test_img/11.png',
                    help='load model')                                      
...
def main():
        ...
        imgL = cv2.resize(imgL,dsize=0,fx=0.5,fy=0.5)
        imgR = cv2.resize(imgR,dsize=0,fx=0.5,fy=0.5)
